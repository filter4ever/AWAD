...
public partial class BestSeller : BasePage
{
    ...
    private DataSet GetDataThriller()
    {
        ...
        using (SqlConnection conn = new SqlConnection(SunnyCS))
        {
            ...
            SqlDataAdapter cmd = new SqlDataAdapter("SELECT * FROM EL_Thriller", conn);
    ...
    private DataSet GetDataFiction()
    {
        ...
        using (SqlConnection conn = new SqlConnection(SunnyCS))
        {
            SqlDataAdapter cmd = new SqlDataAdapter("SELECT * FROM EL_Action", conn);
    ...
    private DataSet GetDataPaperbacks()
    {
        ...
        using (SqlConnection conn = new SqlConnection(SunnyCS))
        {
            SqlDataAdapter cmd = new SqlDataAdapter("SELECT * FROM EL_Comedy", conn);
    ...
    private DataSet GetDataYoungReaders()
    {
        ...
        using (SqlConnection conn = new SqlConnection(SunnyCS))
        {
            SqlDataAdapter cmd = new SqlDataAdapter("SELECT * FROM EL_Romance", conn);
    ...
    private DataSet GetDataTeens()
    {
        ...
        using (SqlConnection conn = new SqlConnection(SunnyCS))
        {
            SqlDataAdapter cmd = new SqlDataAdapter("SELECT * FROM EL_Horror", conn);
